...
## Overview
Text often contains references to the locations of events, where we want to extract the specific location of the event. For example, consider this example tweet that reports a crash in Nairobi, Kenya, where we are interested in extracting the location of the crash:
